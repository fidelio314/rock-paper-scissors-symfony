...
class GameRoundManager
{
    ...
    public function playRound($gameIdentifier, Sign $humanPlayerSign = null)
    {
        ...
        if (true == $game->isAutoMode()) {
            $humanPlayerSign = $this->signManager->getRandomSign();
        }
        ...
        $aiPlayerSign = $this->signManager->getRandomSign($game->getMode(), $game->getPlayerHuman()->getUsername());
    ...
    {
        if ($playerOneRound->getSign()->getVictim() == $playerTwoRound->getSign()->getCode()) {
            return $playerOneRound->getPlayer();
        } elseif ($playerTwoRound->getSign()->getVictim() == $playerOneRound->getSign()->getCode()) {
